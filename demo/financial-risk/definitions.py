...
def financial_risk_dbt_assets(context, dbt: DbtCliResource):
    ...
    try:
        run_id = lineage.emit_start("financial_risk_dbt_assets", run_facets=run_facets or None)
    except Exception:
    ...
    # 4. Emit COMPLETE
    try:
        lineage.emit_complete(run_id, "financial_risk_dbt_assets")
    except Exception:
