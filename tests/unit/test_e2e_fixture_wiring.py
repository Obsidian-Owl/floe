...
def test_service_endpoint_explicit_namespace_overrides_namespace_env(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    """Explicit non-default namespace arguments override FLOE_NAMESPACE."""
    from testing.fixtures.services import ServiceEndpoint
    ...
    endpoint = ServiceEndpoint("polaris", namespace="floe-dev")

    assert endpoint.host == "floe-platform-polaris.floe-dev.svc.cluster.local"
