...
Task: T5
Acceptance Criteria:
    - AC-6: COMPILED_ARTIFACTS_VERSION is "0.17.0"
...
Contract Guarantees:
1. COMPILED_ARTIFACTS_VERSION == "0.17.0" (contract-level assertion)
...
class TestCompiledArtifactsVersionBump:
    """Contract: COMPILED_ARTIFACTS_VERSION must be exactly 0.17.0."""

    @pytest.mark.requirement("T5-AC-6")
    def test_compiled_artifacts_version_is_0_17_0(self) -> None:
        """AC-6: COMPILED_ARTIFACTS_VERSION MUST be '0.17.0'.
        ...
        assert COMPILED_ARTIFACTS_VERSION == "0.17.0", (
            ...
            "expected '0.17.0'. If this is intentional, update this contract test."
        )

    @pytest.mark.requirement("T5-AC-6")
    def test_default_version_on_new_artifacts_is_0_17_0(self) -> None:
        """AC-6: A new CompiledArtifacts instance defaults to version '0.17.0'.
