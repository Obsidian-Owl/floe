...
- Read: worktree `/Users/dmccarthy/Projects/floe-contract-layer-hard-reset`
...
```bash
git -C /Users/dmccarthy/Projects/floe-contract-layer-hard-reset status --short --branch
git -C /Users/dmccarthy/Projects/floe-contract-layer-hard-reset fetch --all --prune
git -C /Users/dmccarthy/Projects/floe-contract-layer-hard-reset log --oneline --decorate --max-count=20
```
...
```bash
git -C /Users/dmccarthy/Projects/floe-contract-layer-hard-reset diff --stat origin/main...HEAD
git -C /Users/dmccarthy/Projects/floe-contract-layer-hard-reset diff --name-status origin/main...HEAD
```
...
sed -n '1,220p' docs/architecture/opinionation-boundaries/index.md
```
