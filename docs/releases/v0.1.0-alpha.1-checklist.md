...
The release evidence bundle must include the Customer 360 run ID, Grafana/Loki
log query and count, Prometheus/Grafana metric query and fresh samples, trace
query and span inventory, Marquez product run plus model/table ParentRunFacet
evidence, and product-vs-infra failure classification.
