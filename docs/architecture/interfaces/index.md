...
| [OrchestratorPlugin](orchestrator-plugin.md) | Job scheduling and execution | `floe_core/interfaces/orchestrator.py` | [ADR-0011](../adr/0011-pluggable-orchestration.md) |
...
| [DBTPlugin](dbt-plugin.md) | dbt compilation environment (local/fusion/cloud) | `floe_core/interfaces/dbt.py` | [ADR-0043](../adr/0043-dbt-runtime-abstraction.md) |
| [SemanticLayerPlugin](semantic-layer-plugin.md) | Business intelligence API | `floe_core/interfaces/semantic_layer.py` | [ADR-0001](../adr/0001-cube-semantic-layer.md) |
...
| [DataQualityPlugin](data-quality-plugin.md) | Data quality validation | `floe_core/interfaces/data_quality.py` | [ADR-0044](../adr/0044-unified-data-quality-plugin.md) |
