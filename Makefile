...
FLOE_DEMO_DAGSTER_EXPECTED_TEXT ?= customer_360
FLOE_DEMO_LINEAGE_EXPECTED_TEXT ?= customer_360
FLOE_DEMO_TRACING_EXPECTED_TEXT ?= customer_360
...
demo-customer-360-validate: ## Validate Customer 360 golden demo evidence
	...
	FLOE_DEMO_DAGSTER_EXPECTED_TEXT="$(FLOE_DEMO_DAGSTER_EXPECTED_TEXT)" \
	FLOE_DEMO_DAGSTER_RUN_CHECK_COMMAND="$(FLOE_DEMO_DAGSTER_RUN_CHECK_COMMAND)" \
	FLOE_DEMO_LINEAGE_EXPECTED_TEXT="$(FLOE_DEMO_LINEAGE_EXPECTED_TEXT)" \
	FLOE_DEMO_LINEAGE_CHECK_COMMAND="$(FLOE_DEMO_LINEAGE_CHECK_COMMAND)" \
	FLOE_DEMO_TRACING_EXPECTED_TEXT="$(FLOE_DEMO_TRACING_EXPECTED_TEXT)" \
	FLOE_DEMO_TRACING_CHECK_COMMAND="$(FLOE_DEMO_TRACING_CHECK_COMMAND)" \
