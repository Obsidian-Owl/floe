"""OpenTelemetry tracing helpers for the Great Expectations Quality Plugin.
...
Example:
    >>> from floe_quality_gx.tracing import get_tracer, quality_span
    >>> tracer = get_tracer()
...
def get_tracer() -> trace.Tracer:
    ...
    the Great Expectations quality plugin. If no tracer provider is configured or
...
def quality_span(
    ...
    *,
    ...
    attributes: dict[str, Any] = {
        ...
        ATTR_PROVIDER: "great_expectations",
    }
