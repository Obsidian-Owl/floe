"""Quality Configuration Schemas (Epic 5B Design Artifact).

This file represents the target Pydantic schemas for quality configuration.
Implementation will be in: packages/floe-core/src/floe_core/schemas/quality_config.py
