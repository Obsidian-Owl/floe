"""Quality Score and Check Result Schemas (Epic 5B Design Artifact).

This file represents the target Pydantic schemas for quality check results
and scoring. Implementation will be in:
...
from .quality_config import Dimension, SeverityLevel
...
class QualityCheckResult(BaseModel):
    ...
    Enhanced from existing QualityCheckResult to include dimension,
    severity, and timing information.
...
class QualitySuiteResult(BaseModel):
    ...
    Enhanced from existing QualitySuiteResult to include model_name,
