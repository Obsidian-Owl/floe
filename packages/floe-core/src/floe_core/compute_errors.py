"""Compute Error Classes for floe-core.

This module defines the exception hierarchy for compute plugin errors.
All compute-related exceptions inherit from ComputeError.

Exception Hierarchy:
    ComputeError (base)
    ├── ComputeConnectionError - Connection failures
    ├── ComputeTimeoutError - Timeout exceeded
    └── ComputeConfigurationError - Invalid configuration
...
class ComputeError(Exception):
    ...
    Example:
        ...
        ComputeError: Connection failed [correlation_id=abc123]
    """
