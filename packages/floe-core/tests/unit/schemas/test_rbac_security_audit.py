"""Unit tests for RBAC security audit models.

Tests the RBAC security audit models migrated from floe-cli.
...
class TestServiceAccountSummary:
    ...
    def test_service_account_summary_creation(self) -> None:
        ...
        from floe_core.schemas.rbac_audit import ServiceAccountSummary
...
class TestNamespaceSummary:
    ...
    def test_namespace_summary_creation(self) -> None:
        ...
        from floe_core.schemas.rbac_audit import NamespaceSummary
