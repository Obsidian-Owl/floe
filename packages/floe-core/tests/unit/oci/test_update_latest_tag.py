...
class TestUpdateLatestTag:
    ...
    def test_update_latest_tag_creates_mutable_tag(
    ...
    @pytest.mark.requirement("8C-FR-003")
    def test_update_latest_tag_overwrites_existing(
        self, controller: MagicMock
    ) -> None:
    ...
    @pytest.mark.requirement("8C-FR-003")
    def test_update_latest_tag_returns_tag_name(
        self, controller: MagicMock
    ) -> None:
    ...
    @pytest.mark.requirement("8C-FR-003")
    def test_update_latest_tag_from_env_tag(
        self, controller: MagicMock
    ) -> None:
