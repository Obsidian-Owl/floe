"""Unit tests for wildcard permission detection.

Tests the detect_wildcard_permissions and check_missing_resource_names
functions for RBAC audit security validation.
...
class TestDetectWildcardPermissions:
    ...
    def test_detect_multiple_wildcards(self) -> None:
        ...
        # Should find 3 wildcards (apiGroups, resources, verbs)
    ...
    def test_no_wildcards_detected(self) -> None:
        ...
        from floe_cli.commands.rbac import detect_wildcard_permissions
    ...
    def test_wildcard_in_multiple_rules(self) -> None:
        ...
        # Rule 1: no wildcards, Rule 2: apiGroups wildcard, Rule 3: verbs wildcard
    ...
    def test_finding_includes_rule_index(self) -> None:
        ...
        assert len(findings) == 1
        assert findings[0].details["rule_index"] == 1  # Second rule
...
class TestCheckMissingResourceNames:
    ...
    def test_no_finding_when_resource_names_present(self) -> None:
        ...
        from floe_cli.commands.rbac import check_missing_resource_names
...
class TestAuditIntegration:
    ...
    def test_combined_wildcard_and_missing_resource_names(self) -> None:
        ...
        # Should find both wildcard and missing resourceNames
    ...
    def test_compliant_role_passes_all_checks(self) -> None:
        ...
        # Compliant rule: specific apiGroups, resources, verbs, and resourceNames
        rules = [
            {
                "apiGroups": [""],
                "resources": ["secrets"],
